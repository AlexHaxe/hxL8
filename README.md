...
[![Build Status](https://travis-ci.org/AlexHaxe/hxL8.svg?branch=travisci)](https://travis-ci.org/AlexHaxe/hxL8)

hxL8 is a Haxe based communication library for L8 smartlight

There are currently two tools based on that library:
* L8Ctl is a command line application for Windows, Mac OSX, Linux and Raspberry Pi that enables you to send commands to your L8 - also comes as Java version
