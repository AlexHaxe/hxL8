...
class L8Ctl extends L8CommBase
{
 ...
 in SuperLED invert(= true), default: false");
        ...
        Sys.println ("Notify \"Phone Call\"|WhatsApp|Facebook|GMail|MobileMail|Tweet|SMS|Line|Instagram|Hangout|GooglePlus|Custom on|mod|off
 category#\n -> display notification, parameters see below");
        Sys.println ("StoreNotification appbundle 64*(RGB|RRGGBB) RGB true|false\n -> creates a new notification for app-bundlename with
 color-matrix and SuperLED color and initial enabled status");
        Sys.println ("");
...
#if cpp
        Sys.println ("StoreFrameFile Filename.png offsetX offsetY\n -> stores a new frame in userspace from PNG file at offsetX/offsetY
 (returns new index of frame)");
#end
        Sys.println ("");
...
#if cpp
        Sys.println ("MatrixLEDFile Filename.png offsetX offsetY\n -> set matrix to 8x8 pixel area of Filename.png at offsetX/offsetY,
 default offset: 0/0 - only PNG supported!");
#end
 ...
 required parameter) with speed 0 = fast, 1 = medium, 2 = slow and true|false for loop, Default: loop = true');
        ...
        Sys.println ("--------------------");
        Sys.println ("Repeat #|forever delay\n -> repeats all commands number of times specified or forever with optional delay
 (specified in 100th of a second) between commands");
        Sys.println ("RepeatSilent #|forever delay\n -> repeats all commands number of times specified or forever with optional delay
 (specified in 100th of a second) between commands without printing responses from L8");
        Sys.println ("");
        ...
        Sys.println ("\"Phone Call\"|WhatsApp|Facebook|GMail|MobileMail|Tweet|SMS|Line|Instagram|Hangout|GooglePlus|Custom - name of notification
 to display, Custom = use your own notification");
        ...
        Sys.println ("category# - notification category number (0 = Other|1 = Incoming Call|2 = MIssed Call|3 = Voice Mail|4 = Social|5 =
 Schedule|6 = E-Mail|7 = News|8 = Health/Fitness|9 = Business/Finance|10 = Location|11 = Entertainment|255 = Unknown)");
        Sys.println ("");
